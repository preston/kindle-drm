...
# Navigate to the device's "Settitngs" screen.
# Type "411" (without the quotes) on the keyboard.
# A secret page should now open. Write down the 16-character serial number of the device. (iPhone serial numbers are different but should also work.)
